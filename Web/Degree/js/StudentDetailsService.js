...
var StudentDetailsServiceViewModel = (function(){
    var model = function(http,warningMessageService,rootScope){
        ...
        self.CriteriaTemplate = '/Degree/Templates/StudentDetails/StudentDetailsCriteriaOneTemplate.html';
        self.CriteriaTemplates = [
            '/Degree/Templates/StudentDetails/StudentDetailsCriteriaOneTemplate.html',
            '/Degree/Templates/StudentDetails/StudentDetailsCriteriaTwoTemplate.html',
            '/Degree/Templates/StudentDetails/StudentDetailsCriteriaThreeTemplate.html'
        ];
        ...
        self.SearchStudents = function (criteria) {
            ...
            http({
                method: 'GET',
                url: '/api/Degreestudent?' + queryStrings + '&Criteria=' + criteria
            })
