...
var StudentProfileServiceViewModel = (function(){
    var model = function(http,rootScope,warningMessageService){
        ...
        self.LoadStudentFeeDetails = function(){
            http({
                method:'GET',
                url :'/api/student?id=' + self.Student.Id
            })
        ...
        self.NewAdmission = function(){
            warningMessageService.OpenPopup({template:'/Diploma/Templates/AddFeeDetailsModalTemplate.html',controller:'AddFeeDetailsModalController', Callback:self.LoadStudentFeeDetails});
        };
        ...
        self.UpdateFeeDetails = function(fee){
            ...
            warningMessageService.OpenPopup({ template: '/Diploma/Templates/EditFeeDetailsModalTemplate.html', controller: 'EditFeeDetailsModalController', Callback: self.LoadStudentFeeDetails });
        };
    };
