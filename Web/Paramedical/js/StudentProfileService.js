...
var StudentProfileServiceViewModel = (function(){
    var model = function(http,rootScope,warningMessageService){
        ...
        self.LoadStudentFeeDetails = function(){
            http({
                method:'GET',
                url: '/api/paramedicalstudent?id=' + self.Student.Id
            })
        ...
        self.NewAdmission = function(){
            warningMessageService.OpenPopup({ template: '/Paramedical/Templates/AddFeeDetailsModalTemplate.html', controller: 'AddFeeDetailsModalController', Callback: self.LoadStudentFeeDetails });
        };
        ...
        self.UpdateFeeDetails = function(fee){
            ...
            warningMessageService.OpenPopup({ template: '/Paramedical/Templates/EditFeeDetailsModalTemplate.html', controller: 'EditFeeDetailsModalController', Callback: self.LoadStudentFeeDetails });
        };
    };
