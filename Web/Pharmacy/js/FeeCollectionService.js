...
var FeeCollectionServiceViewModel = (function () {
    var model = function (http) {
        ...
        self.Keys = ['CourseFee', 'CautionDepositFee', 'AdmissionFee', 'HomeExamFee', 'MedicalFee',
            'IdentityCardFee', 'MisFee', 'LibraryFee', 'LabFee', 'MagazineFee',
            'LibDepositFee', 'StudentAidFundFee', 'SportsFee', 'JournalFee', 'OtherFee'
        ];
        self.Fee = {};
        ...
        self.FindStudent = function () {
            ...
            http({
                method: 'GET',
                url: '/api/Pharmacystudent?studentId=' + self.Id
            })
        ...
        self.FindStudentFeesDetails = function () {
            http({
                method: 'GET',
                url: '/api/Pharmacystudent?Id=' + self.Id
            })
            .success(function (data) {
                self.ShowLoader = false;
