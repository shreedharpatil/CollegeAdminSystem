...
var FeeCollectionServiceViewModel = (function () {
    var model = function (http) {
        ...
        self.Keys = ['CourseFee', 'CautionDepositFee', 'AdmissionFee', 'PhyciatricFee', 'MedicalFee',
             'TransportationFee', 'ExaminationFee', 'LibraryFee', 'LabFee', 'HostelFee',
             'MessFee', 'BooksFee', 'SportsFee', 'UniformFee', 'OtherFee'
        ];
        self.Fee = {};
        ...
        self.FindStudent = function () {
            ...
            http({
                method: 'GET',
                url: '/api/Nursingstudent?studentId=' + self.Id
            })
        ...
        self.FindStudentFeesDetails = function () {
            http({
                method: 'GET',
                url: '/api/Nursingstudent?Id=' + self.Id
            })
            .success(function (data) {
                self.ShowLoader = false;
