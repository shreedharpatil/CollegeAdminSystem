...
{
    public class GenerateParamedicalFeeReceiptQuery : IQueryFor<Student, MemoryStream>
    {
        public MemoryStream ExecuteQueryWith(Student student)
        {
            ...
            var pp1 = new PdfPCell(new Phrase("", FontFactory.GetFont("Arial", 12)));
            ...
            var p3 = new PdfPCell(new Phrase("NIVEDITA PARA MEDICAL COLLEGE", times));

            var p4 = new PdfPCell(new Phrase("(Recognised by Para Medical Board, Bangalore)", FontFactory.GetFont("Arial", 12)));
            ...
            var s1 = new PdfPCell(new Phrase("No.", GetFont(12f)));
