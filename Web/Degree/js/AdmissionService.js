...
var AdmissionServiceViewModel = (function(){
    var model = function (http, warningMessageService, rootScope, commonModalService) {
        ...
        self.UploadPhoto = function(data){
            ...
            http.post('/api/DegreeUploadPhoto', formData, {
        ...
        self.CheckSeatsAvailbility = function () {
            http({
                method: 'GET',
                url: '/api/DegreeCheckSeats?Quota=' + self.Admission.Quota + '&BranchId=' + self.Admission.BranchId
            })
            .success(function (data) {
                if (data) {                    
                    self.AdmitStudent();
        ...
        self.ShowMessage = function (title,content) {
            ...
            warningMessageService.OpenPopup({ template: '/Degree/Templates/CommonModalTemplate.html', controller: 'CommonModalController', Heading: title, Body: content });
        };
    };
