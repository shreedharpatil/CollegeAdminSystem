...
var StudentDetailsServiceViewModel = (function(){
    var model = function(http,warningMessageService,rootScope){
        ...
        self.CriteriaTemplate = '/Nursing/Templates/StudentDetails/StudentDetailsCriteriaOneTemplate.html';
        self.CriteriaTemplates = [
            '/Nursing/Templates/StudentDetails/StudentDetailsCriteriaOneTemplate.html',
            '/Nursing/Templates/StudentDetails/StudentDetailsCriteriaTwoTemplate.html',
            '/Nursing/Templates/StudentDetails/StudentDetailsCriteriaThreeTemplate.html'
        ];
        ...
        self.SearchStudents = function (criteria) {
            ...
            http({
                method: 'GET',
                url: '/api/Nursingstudent?' + queryStrings + '&Criteria=' + criteria
            })
