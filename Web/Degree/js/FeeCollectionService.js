...
var FeeCollectionServiceViewModel = (function () {
    var model = function (http) {
        ...
        self.Keys = ['CourseFee', 'IdentityCardFee', 'ReadingRoomFee', 'MagazineFee', 'AnnualDayFee',
            'StudentWelfareFundFee', 'TeacherBenefitFundFee', 'LibraryFee', 'LabFee', 'CollegeSportsFee',
            'ApplicationFee', 'HomeExamFee', 'MedicalExamFee', 'UnionFee', 'StudentAidFundFee',
            'ScienceDevelopmentFee', 'UniversityRegistrationFee', 'EligibilityApplicationFee', 'EligibilityFee', 'UniversitySportsFee',
            'UniversityWelfareFee', 'CarrierGuidenceFundFee', 'CorpusFundFee', 'ArrearFee', 'NssFee',
            'CollegeDevelopmentFee', 'UniversitysilverJubileeFee', 'MiscellaneousFee'
        ];
        self.Fee = {};
        ...
        self.FindStudent = function () {
            ...
            http({
                method: 'GET',
                url : '/api/Degreestudent?studentId=' + self.Id
            })
        ...
        self.FindStudentFeesDetails = function () {
            http({
                method: 'GET',
                url: '/api/Degreestudent?Id=' + self.Id
            })
            .success(function (data) {
                self.ShowLoader = false;
