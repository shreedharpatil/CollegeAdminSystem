...
angular.module('DAS').service('AdminService', function ($location,$http) {
    ...
    self.Logout = function () {
        ...
        $http({
            method: 'GET',
            url:'/api/Logout?application=paramedical'
        })
...
angular.module('DAS').config(function($routeProvider) {
    $routeProvider.
        when('/admission', {
            templateUrl: '/Paramedical/Templates/AdmissionTemplate.html',
            controller: 'AdmissionController'
        })
        .when('/studentdetails', {
            templateUrl: '/Paramedical/Templates/StudentDetailsTemplate.html',
            controller: 'StudentDetailsController'
        })
        .when('/quotamanagement', {
            templateUrl: '/Paramedical/Templates/QuotaManagementTemplate.html',
            controller: 'QuotaManagementController'
        })
        .when('/audit', {
            templateUrl: '/Paramedical/Templates/AuditTemplate.html',
            controller: 'AuditController'
        })
         .when('/feescollection', {
             templateUrl: '/Paramedical/Templates/FeeCollectionTemplate.html',
             controller: 'FeeCollectionController'
         })
    .when('/receipt', {
        templateUrl: '/Paramedical/Templates/DownloadReceiptTemplate.html',
