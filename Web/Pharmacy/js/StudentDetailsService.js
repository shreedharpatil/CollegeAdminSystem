...
var StudentDetailsServiceViewModel = (function(){
    var model = function(http,warningMessageService,rootScope){
        ...
        self.CriteriaTemplate = '/Pharmacy/Templates/StudentDetails/StudentDetailsCriteriaOneTemplate.html';
        self.CriteriaTemplates = [
            '/Pharmacy/Templates/StudentDetails/StudentDetailsCriteriaOneTemplate.html',
            '/Pharmacy/Templates/StudentDetails/StudentDetailsCriteriaTwoTemplate.html',
            '/Pharmacy/Templates/StudentDetails/StudentDetailsCriteriaThreeTemplate.html'
        ];
        ...
        self.SearchStudents = function (criteria) {
            ...
            http({
                method: 'GET',
                url: '/api/Pharmacystudent?' + queryStrings + '&Criteria=' + criteria
            })
