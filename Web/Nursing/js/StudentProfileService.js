...
var StudentProfileServiceViewModel = (function(){
    var model = function(http,rootScope,warningMessageService){
        ...
        self.LoadStudentFeeDetails = function(){
            http({
                method:'GET',
                url: '/api/Nursingstudent?id=' + self.Student.Id
            })
        ...
        self.NewAdmission = function(){
            warningMessageService.OpenPopup({ template: '/Nursing/Templates/AddFeeDetailsModalTemplate.html', controller: 'AddFeeDetailsModalController', Callback: self.LoadStudentFeeDetails });
        };
        ...
        self.UpdateFeeDetails = function(fee){
            ...
            warningMessageService.OpenPopup({ template: '/Nursing/Templates/EditFeeDetailsModalTemplate.html', controller: 'EditFeeDetailsModalController', Callback: self.LoadStudentFeeDetails });
        };
    };
